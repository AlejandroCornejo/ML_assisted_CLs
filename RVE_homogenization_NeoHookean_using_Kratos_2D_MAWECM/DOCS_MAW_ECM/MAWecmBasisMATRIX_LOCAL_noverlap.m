...
% See ../DOCS/DOC_MAWecmBasisMATRIX_LOCAL_noverlap.pdf
%
% PURPOSE
% -------
...
numberOfSamples = size(qLATENT,2) ;

wADAPT = zeros(length(zINI),numberOfSamples) ;
numberMODES = zeros(numberOfSamples,1) ;
U = cell(size(A));
b = cell(size(A,1),1) ;
