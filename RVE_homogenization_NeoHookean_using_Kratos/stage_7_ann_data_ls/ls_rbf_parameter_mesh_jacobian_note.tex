...
\begin{verbatim}
python3 stage7a_prepare_rbf_dataset_ls.py --n-primary 3 --out-dir stage_7_ann_data_ls --plot-max-samples 110000 --jacobian-mesh-type structured_hex --jacobian-mesh-max-points 6000 --jacobian-mesh-seed 42 --jacobian-ls-max-iters 4 --jacobian-ls-mesh-max-points 4096 --jacobian-ls-drop-fraction 1.0 --jacobian-ls-min-samples 6000
\end{verbatim}
...
negative $\det(\partial q^{LS}/\partial\mu)$ count & 2957 \\
$\min |\det(J_\mu)|$ & 1.795237e-04 \\
$\min\det(\partial q^{LS}/\partial\mu)$ & -3.950313e-01 \\
