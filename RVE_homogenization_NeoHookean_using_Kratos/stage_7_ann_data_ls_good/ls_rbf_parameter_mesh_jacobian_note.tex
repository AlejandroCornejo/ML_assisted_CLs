...
\begin{verbatim}
python3 stage7a_prepare_rbf_dataset_ls.py --n-primary 3 --out-dir stage_7_ann_data_ls --plot-max-samples 110000 --jacobian-mesh-type delaunay --jacobian-mesh-max-points 6000 --jacobian-mesh-seed 42
\end{verbatim}
...
negative $\det(\partial q^{LS}/\partial\mu)$ count & 567 \\
$\min |\det(J_\mu)|$ & 1.001803e-20 \\
$\min\det(\partial q^{LS}/\partial\mu)$ & -1.474394e+12 \\
