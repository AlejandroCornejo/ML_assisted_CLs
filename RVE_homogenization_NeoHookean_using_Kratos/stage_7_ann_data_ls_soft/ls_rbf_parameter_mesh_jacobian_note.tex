...
\begin{verbatim}
python3 stage7a_prepare_rbf_dataset_ls.py --n-primary 3 --out-dir stage_7_ann_data_ls_soft --jacobian-ls-max-iters 8 --jacobian-ls-drop-fraction 0.25 --jacobian-mesh-type structured_hex
\end{verbatim}
...
negative $\det(\partial q^{LS}/\partial\mu)$ count & 2955 \\
$\min |\det(J_\mu)|$ & 1.795237e-04 \\
$\min\det(\partial q^{LS}/\partial\mu)$ & -3.359435e-01 \\
