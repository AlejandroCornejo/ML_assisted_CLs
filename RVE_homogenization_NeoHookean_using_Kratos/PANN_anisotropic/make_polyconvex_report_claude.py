...
def main() -> None:
    ...
    hprom = result["direct_hprom_ann_reference_same_path"]
    ...
    names = {
        ...
        "DHpromEnergyError": percentage(hprom["energy_relative_l2"]),
        "DHpromStressError": percentage(hprom["stress_relative_l2"]),
        "DHpromSxxError": percentage(hprom["stress_component_relative_l2"][0]),
        "DHpromSyyError": percentage(hprom["stress_component_relative_l2"][1]),
        "DHpromSxyError": percentage(hprom["stress_component_relative_l2"][2]),
