...
"""
Stage 7c: compare reconstruction bounds and manifold closures on one trajectory.

Compares:
  - POD rank-4
  - POD rank-9 projection floor
  - PROM-ANN reconstruction
  - PROM-RBF reconstruction
  - PROM-POD-DL reconstruction
"""

from stage7c_reconstruction_check import run_stage7c_bounds_comparison


if __name__ == "__main__":
    import argparse

    p = argparse.ArgumentParser(description="Stage 7c: POD4/POD9/ANN/RBF/POD-DL reconstruction comparison")
