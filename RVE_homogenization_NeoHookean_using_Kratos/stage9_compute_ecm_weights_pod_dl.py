...
"""
Stage 9b: Compute ECM weights for HPROM-POD-DL.
...
DATA_DIR = "stage_9_ecm_dataset_pod_dl"
OUT_DIR = "stage_9_hprom_pod_dl_data"
...
def parse_args():
    p = argparse.ArgumentParser(description="Stage 9b-POD-DL: compute ECM weights from a Stage-9 dataset.")
...
def main():
    ...
    print("=" * 60)
    print("  Stage 9b-POD-DL: ECM Weight Computation")
    print("=" * 60)
    print(f"  nq (POD-DL latent modes) = {nq}")
    ...
    print("\n" + "=" * 60)
    print("  ELEMENT SELECTION SUMMARY (HPROM-POD-DL)")
    print("=" * 60)
