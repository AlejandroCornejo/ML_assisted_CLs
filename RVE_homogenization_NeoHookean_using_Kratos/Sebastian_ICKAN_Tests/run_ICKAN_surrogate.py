...
if not args.skip_kan_plot:
    ...
    # plt.show()
    plt.savefig(os.path.join(out_dir, "ICKAN.eps"))
...
plt.legend()
plt.grid()
plt.savefig(os.path.join(out_dir, "W_history_x.eps"))
...
plt.legend()
plt.grid()
plt.savefig(os.path.join(out_dir, "W_history_y.eps"))
...
plt.legend()
plt.grid()
plt.savefig(os.path.join(out_dir, "W_history_xy.eps"))
...
plt.legend()
plt.grid()
plt.savefig(os.path.join(out_dir, "S_xx_history.eps"))
...
plt.legend()
plt.grid()
plt.savefig(os.path.join(out_dir, "S_yy_history.eps"))
...
plt.legend()
plt.grid()
plt.savefig(os.path.join(out_dir, "S_xy_history.eps"))
