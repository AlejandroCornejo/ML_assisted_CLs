...
RVE_homogenization_NeoHookean_using_Kratos/mawecm_pruning.py (the
pre-reorganization sibling project), so this project is self-contained with
no runtime dependency on that directory. Only the sibling import was updated
(mawecm_graph_utils -> mawecm_graph_utils_claude); no logic changed.
"""
...
from mawecm_graph_utils_claude import edge_jump_metrics
