#!/usr/bin/env python3
"""Same decisive precision-floor test as
diagnose_newton_trajectory_float64_claude.py, for HPROM-ANN-iterative's
float64 copy instead of D-HPROM-ANN's.
"""
...
def run_step1_float64(nx=8, ny=8, max_it=15):
    ...
    fom._neo_hookean_pk2_2d_vectorized = hprom_iter_f64_module.hprom_ann_iterative_pk2_2d_vectorized_consistent_float64
    assembler = fom.VectorizedAssembler(mp, n_dof, eq_map, log_label="diag-hprom-iter-float64")
...
if __name__ == "__main__":
    print("[diag-float64] running Cook step-1 Newton with HPROM-ANN-iterative-consistent-FLOAT64 ...")
