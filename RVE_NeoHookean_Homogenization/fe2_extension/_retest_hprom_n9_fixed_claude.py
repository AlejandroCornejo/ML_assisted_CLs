...
res = rc.run_newton_fe2_cruciform(
    "hprom_iterative_f64_continuation", n_body=9, n_arm_len=6, n_steps=20,
...
g12 = np.abs(d["e_gp"][:, 2])
print(f"[hprom_iterative_f64_continuation] n_body=9 fully_converged={res['fully_converged']}, "
...
print("RETEST_DONE_MARKER", flush=True)
