...
# NOTE: the pre-reorganization DEFAULT_RESULT_DIR pointed at
# stage_10_hprom_ann_ls_results_mawecm_..._ann_hrom, which a later
# investigation found does not match the canonical Stage-10 trajectory (see
# repo-level DATA_DICTIONARY.md). That directory was not migrated. Point this
# at a freshly regenerated run (see hprom/ann/README or the top-level
# DATA_DICTIONARY.md) before re-rendering this animation.
DEFAULT_RESULT_DIR = PROJECT_DIR / "hprom" / "ann" / "stage_10_results_maw_dynamic"
DEFAULT_ECM_FILE = PROJECT_DIR / "hprom" / "ann" / "maw_dynamic" / "ecm_weights_all.npz"
# Previously pointed at the superseded plain stage_7_ann_model_ls checkpoint
# (val error 3.28e-4); the migration renamed the canonical _newton checkpoint
# (val error 2.61e-4) to this same name, so this default is now correct.
DEFAULT_ANN_DIR = PROJECT_DIR / "prom" / "ann" / "stage_7_ann_model_ls"
DEFAULT_POD_DIR = PROJECT_DIR / "pod" / "stage_2_pod_rve"
DEFAULT_MDPA_FILE = PROJECT_DIR / "core" / "rve_geometry.mdpa"
