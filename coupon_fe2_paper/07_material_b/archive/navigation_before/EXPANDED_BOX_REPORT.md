...
[Decision and checks](expanded_decision_v1.json) ·
...
The [saved-field diagnostic](expanded_field_audit_v1/audit.json) and
[contour figure](expanded_field_audit_v1/compression_shear_contours.png)
...
A read-only [saved-reference audit](reference_linearity_v1.json) gives
...
A more demanding [fit-only constant-tangent diagnostic](constant_tangent_v1.json)
