...
Those failures remain in [pilot_v1](../archive/pilot_v1/report.json).
...
- [Targeted retry, d = 800](../archive/refinement_retry_800/report.json) and
  [d = 1600](../refinement_retry_1600/report.json).
- [Saved-field audit](../results/saved_field_audit_v2.json).
- [Complete reference cross-check](../results/reference_verification_v2_complete.json).
