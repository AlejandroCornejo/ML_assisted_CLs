% Archived comparison table; no longer included in the manuscript.
\begingroup
\footnotesize
...
\caption{Positioning of the present study relative to neural constitutive models and projection-based reduced-order models. Properties refer to the specified formulation and its hypotheses, not to all models sharing an architecture name.}
