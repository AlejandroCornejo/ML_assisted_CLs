...
\end{table}
\FloatBarrier
Section~\ref{sec:cell} now evaluates two separate questions: whether the implementations reproduce these constructions and how accurately the resulting energies approximate the RVE response.
