...
\label{app:cubature}
This appendix records the implementation conventions omitted from Section~\ref{sec:reduced}. The general ECM construction and MAW--ECM pruning algorithm follow Refs.~\cite{hernandez2017,hernandez2026}; the expressions below specify how the deployed residual and stress rules are assembled.
